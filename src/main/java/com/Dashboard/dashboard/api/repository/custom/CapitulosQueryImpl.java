...
public class CapitulosQueryImpl implements CapitulosQuery {
    @PersistenceContext
    private EntityManager entityManager;

    @Override
    public Page<CapitulosAutores> capitulosFiltroPaginado(Long fk_curriculo, Pageable pageable){
    ...
    public List<CapitulosAutores> capitulosFiltro(Long fk_curriculo, Pageable pageable){
        ...
        hql.append(" order by c.fkCapitulo.ANO_TRABALHO desc");
